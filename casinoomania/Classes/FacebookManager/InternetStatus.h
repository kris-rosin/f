...
public:
    static bool hasInternetConnection()
    {
        ...
        if (! cocos2d::JniHelper::getStaticMethodInfo(methodInfo, "com/codeexotics/tools/Connectivity", "isConnectedToInternet", "()Z")) {
            return false;
        }
    ...
    static bool isConnectionFast()
    {
        ...
        if (! cocos2d::JniHelper::getStaticMethodInfo(methodInfo, "com/codeexotics/tools/Connectivity", "isConnectionTypeFast", "()Z")) {
            return false;
        }
    ...
    static bool isConnectionTypeMobile()
    {
        ...
        if (! cocos2d::JniHelper::getStaticMethodInfo(methodInfo, "com/codeexotics/tools/Connectivity", "isConnectionTypeMobile", "()Z")) {
            return false;
        }
